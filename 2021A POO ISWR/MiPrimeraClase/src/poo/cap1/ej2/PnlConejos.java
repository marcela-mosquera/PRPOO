...
public class PnlConejos extends javax.swing.JPanel {
    ...
    public void llenarTabla(){
        dtmModelo.setRowCount(0); //limpiando la tabla
    ...
    private void initComponents() {
        ...
        cmbOpciones.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Edad", "Peso", "Nombre" }));
    ...
    private void cmbOpcionesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbOpcionesActionPerformed
        ...
        if (cmbOpciones.getSelectedIndex() == 0 ){
            //el usr quiere que la lista se ordene de acuerdo al edad - ORDEN NATURAL
            Collections.sort(GUIConejo.conejos);
            llenarTabla();
        }
        
        if(cmbOpciones.getSelectedIndex() == 1){
            //el usr quiere que la lista se ordene de acuerdo al peso - ORDEN TOTAL
            Collections.sort(GUIConejo.conejos, new OrdenamientoPorPeso());
            llenarTabla();
        }
        
        if(cmbOpciones.getSelectedIndex() == 2){
            //el usr quiere que la lista se ordene de acuerdo al nombre - ORDEN TOTAL
            Collections.sort(GUIConejo.conejos, new OrdenamientoPorNombre());
            llenarTabla();
        }
